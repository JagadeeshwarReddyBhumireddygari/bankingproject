...
public class App {
	...
	public static void main(String[] args) {
		...
		System.out.println("select 9 to count pancard");		
		...
		String pan0 = input.next();
		System.out.println("Enter opening balance");
		double balance0 = input.nextDouble();
		System.out.println("Enter gender");
		String gender0 = input.next();
		AccDetails accdetails = new AccDetails(name0,phone,address0,pan0,balance0,gender0);
		...
		case 9:{
			AccountRepository accRepository = new JdbcAccountRepository();
			System.out.println("Enter accountid to retrive pan");
			int nl = input.nextInt();
			accountRepository.getpanc(nl);
		}
		}
		}
		else {
